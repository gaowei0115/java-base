...
/** 
 * className: SimpleInsertSortTest<br/>
 * Description: 插入排序测试<br/>
 * Author: GW<br/>
...
public class SimpleInsertSortTest {
	...
	public static void main(String[] args) {
		BaseSort<Double> sort = new SimpleInsertSort();
		...
		System.out.println("插入排序 end cost time " + (end - start) + " ms");
...
//		}
	...
	public void testMedia() {
		SimpleInsertSort sort = new SimpleInsertSort();
		Double[] arrays = new Double[10];
		Double d1 = new Double(42.7);
		Double d2 = new Double(22.3);
		Double d3 = new Double(12.56);
		...
		Double double1 = sort.media(arrays);
		System.out.println("数组中间值 ： " + double1);
